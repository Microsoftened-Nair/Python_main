...
# Form implementation generated from reading ui file 'YT_downloaderUi.ui'
#
...
import YT_downloader_module as ytm
...
"color: rgb(34, 37, 255);")
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 640, 621, 23))
...
"color: rgb(0, 255, 247);")
        ...
        self.Dir_go = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: self.directory())
...
"color: rgb(0, 255, 247);")
        ...
        self.link_go = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: self.get_info())
...
"color: rgb(0, 255, 247);")
        ...
        self.L_ChName.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(255, 255, 255, 0));\n"
"color: rgb(34, 37, 255);")
    ...
    def get_info(self):
        ...
        self.Vid_title.setText('Video title: ' + yt1.title)
        self.L_ChName.setText('Channel: ' + ch_name.channel_name)
        self.Vid_Length.setText('Video length: ' + str(round(yt1.length / 60, 1)) + 'min')
    ...
    def download(self):
        ytm.download_video(link, option, path)
